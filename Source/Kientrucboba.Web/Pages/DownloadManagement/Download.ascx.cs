...
namespace Cb.Web.Pages.DownloadManagement
{
    public partial class Download : DGCUserControl
    {
        #region Parameter
        ...
        protected void rptResult_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                //View and print
                if (data.Bathroom != "" && data.Bathroom != string.Empty)
                {
                    HtmlControl divPdf = e.Item.FindControl("divPdf") as HtmlControl;
                    divPdf.Style.Add("display", "block");

                    LinkButton lbnViewFile = e.Item.FindControl("lbnViewFile") as LinkButton;
                    lbnViewFile.CommandArgument = data.Bathroom;
                }

                Literal ltrDownload = e.Item.FindControl("ltrDownload") as Literal;
                ltrDownload.Text = LocalizationUtility.GetText("ltrDownload", Ci);
            }
        }
